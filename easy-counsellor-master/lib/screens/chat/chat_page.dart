      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: Text("Are you sure you want to close this case?"),
              actions: <Widget>[
                FlatButton(
                  child: Text("NO"),
                  onPressed: () async {
                ...
                FlatButton(
                  ...
                  onPressed: () async {
                    Navigator.pop(context);
                    DBService.instance.closeCase(widget.receiverID);
                  },
                )
              ],
            );
        ...
        actions: <Widget>[
          Padding(
            ...
            child: GestureDetector(
              child: Tooltip(child: Icon(Icons.delete), message: "Sign in"),
              onTap: () async {
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isUserMessage = message.senderID == user.uid;
  ...
  Widget _textMessageBubble2(bool _isUserMessage, String _message, Timestamp _timestamp) {
    return _isUserMessage
        ? Bubble(
            ...
            color: Colors.green,
            child: Text(_message, textAlign: TextAlign.right, style: TextStyle(color: Colors.white, fontSize: 20)),
          )
        : Bubble(
            margin: BubbleEdges.only(top: 10),
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            border: InputBorder.none, hintText: "Type a message", hintStyle: TextStyle(color: Colors.grey)),
      ),
    );
  }
